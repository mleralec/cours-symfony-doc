...
Dans votre méthode **new**, vous pouvez maintenant utiliser la fonction `createForm` qui prend en premier argument le Form Builder et en deuxième argument un nouvel article :
